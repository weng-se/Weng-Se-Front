      ...
      <CustomScrollbars className=" scrollbar">
        <ul className="nav-menu">
          ...
          <li className="menu">
            ...
            <ul className="sub-menu">
              <li>
                <NavLink className="prepend-icon" to="/app/users/listUser">
                  <span className="nav-text"><IntlMessages id="pages.listUsers" /></span>
                </NavLink>
              </li>
              <li>
                <NavLink className="prepend-icon" to="/app/users/addUser">
                  <span className="nav-text"><IntlMessages id="pages.addUsers" /></span>
                </NavLink>
              </li>
              <li>
                <NavLink className="prepend-icon" to="/app/users/editUser">
